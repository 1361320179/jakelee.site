...
| --- | --- | --- | --- |
| Strong SEO on first load | Weak unless pre-rendered | Strong | Strong |
| Personalized first paint | Medium | Strong | Weak |
| Lowest infra cost | Medium | Weak | Strong |
| Best cacheability | Medium | Medium | Strong |
| Rich client interactions after boot | Strong | Strong | Strong |
| Best fit for content sites | Weak | Medium | Strong |
| Best fit for internal apps | Strong | Medium | Weak |

This table is intentionally simplified. The important point is that no option dominates on every axis.
